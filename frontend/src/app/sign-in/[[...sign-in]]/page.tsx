        ...
        <div className="max-w-4xl w-full">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Welcome back to <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-green-600">Finkargo</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Access your supply chain intelligence dashboard and continue optimizing your operations.
            </p>
          </div>
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Real-time stock levels and demand forecasting</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Live KPIs and performance metrics</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Automated monitoring and alerts</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-6 border border-green-100">
                <p className="text-sm text-gray-600 text-center">
                  <span className="font-semibold text-green-600">Secure access</span> • 
                  <span className="font-semibold text-blue-600"> Multi-factor authentication</span> • 
                  <span className="font-semibold text-purple-600"> 24/7 monitoring</span>
                </p>
              </div>
            </div>
          ...
          <div className="text-center mt-8">
            <p className="text-sm text-gray-500">
              ...
              <a href="/sign-up" className="font-medium text-blue-600 hover:text-blue-700 transition-colors">
                Sign up here
              </a>
            </p>
          </div>
