...
def get_triangle_analytics(org_id):
    ...
    try:
        # Enhanced mock data that looks real
        triangle_data = {
            "service_score": 85.5,
            "cost_score": 78.2,
            "capital_score": 92.1,
...
def get_cross_reference_analytics(org_id):
    ...
    try:
        # Enhanced mock data for cross-reference analysis
        cross_ref_data = {
...
def get_supplier_performance(org_id):
    ...
    try:
        # Enhanced mock data for supplier performance
        supplier_data = {
            "suppliers": [
                {
                    "id": "supp_001",
...
def get_market_intelligence(org_id):
    ...
    try:
        # Enhanced mock data for market intelligence
        market_data = {
            "market_segments": [
...
def analytics_health():
    ...
    return jsonify({
        ...
        "endpoints": [
            "/triangle/<org_id>",
            "/cross-reference/<org_id>",
            "/supplier-performance/<org_id>",
            "/market-intelligence/<org_id>",
            "/uploads/<org_id>"
        ],
        "timestamp": datetime.utcnow().isoformat()
    })